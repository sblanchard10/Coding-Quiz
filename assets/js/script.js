...
var questions = [
  {
    question:
      "Which of the following is NOT a valid way to declare a JS variable?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: "var foo = bar() {console.log('something');}",
        score: 0,
        correct: false,
      },
      {
        text: "var foo = function() {console.log('something');}",
        score: 5,
        correct: true,
      },
      {
        text: "function() {console.log('something')}",
        score: 0,
        correct: false,
      },
    ],
  ...
  {
    question:
      "True or False: JavaScript arrays are defined with square brackets ([]).",
    answers: [
...
var runTimer = function () {
  timerInterval = setInterval(function () {
    ...
    timerElement.innerHTML =
      "<h3>Time Remaining: " + minutesLeft + ":" + secondsLeft + "</h3>";
...
var displayQuestion = function () {
  if (questionsAnswered < questions.length) {
    ...
    questionContainer.innerHTML =
      "<h2>" + questions[questionsAnswered].question + "</h2>";
...
var highScoreSubmitHandler = function (event) {
  ...
  var playerName = event.target.querySelector(
  ...
  if (!loadedScores) {
    ...
    for (let i = 0; i < loadedScores.length; i++) {
      ...
      scoreListItem.innerHTML =
        "<p class='high-score-player'>" +
        loadedScores[i].player +
        " - " +
        loadedScores[i].score +
        " points - " +
        loadedScores[i].date +
        "</p>";
